        ...
        <div className="flex-1 space-y-8 text-center sm:text-left">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-400">
              Customize workflows to align with the specific requirements of
              insurance carriers and lines of business (LoB). Tailor
              questionnaires and site survey templates to ensure all necessary
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-400">
              As you capture photos and videos on site, {appName}&apos;s AI
              engine processes the information. It automatically recognizes
              items in your photos and annotates damages, reducing the need for
